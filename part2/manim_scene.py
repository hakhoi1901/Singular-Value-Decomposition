...
class Scene1_AnatomyOfChaos(MovingCameraScene):
    ...
    def beat_1_1_orthonormal_basis(self):
        ...
        self.wait(0.5)
        self.show_subtitle("Tại lõi của nó, hai vector cơ sở $\hat{i}$ và $\hat{j}$ thiết lập một góc vuông tuyệt đối. Đây là nền tảng nguyên thủy của không gian – trạng thái trực chuẩn")
    ...
    def beat_1_3_loss_of_orthogonality(self):
        ...
        dot_eq.arrange(RIGHT, buff=0.22).to_edge(DOWN, buff=0.55)
